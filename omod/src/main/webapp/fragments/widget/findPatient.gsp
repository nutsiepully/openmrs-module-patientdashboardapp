<%
    ...
    // defaults
    config.merge([
            targetPageProvider: "patientDashboardApp",
            targetPage: "patient"
    ])
%>
...
<form id="patient-search-form" class="patient-search-form">
    <label>
        ...
        ${ ui.message("patientDashboardApp.searchPatientHeading") }
    </label>
    <div class="search-input">
        ${ ui.includeFragment("patientDashboardApp", "field/autocomplete", [
                id: "patient-search-field",
                cssClass: "scan-input",
                label: "",
                placeholder: ui.message("patientDashboardApp.searchByNameOrIdOrScan"),
